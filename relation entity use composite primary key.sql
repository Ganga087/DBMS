...
select id,name,department from employee where department ='HR'
...
select department , cnt from cte 
...
select id,name,salary ,department from hr_employees
where salary > (select max(salary) from testing_employees);

select id,name,salary,department from employee where department ='HR' and
salary > (select max(salary) from employee where department ='Testing');
