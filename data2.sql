...
select branch , count(name) from student
...
select sum(fee)
from student 
where college = 'AEC' or college = 'ACOE';
select college , count(name)
from student 
group by college;
select gender , count(*) from student 
group by gender;
select date_of_admission , count(*) from student 
group by date_of_admission;
select count(*)
from student 
select min(age) from student where college = 'ACOE';

where branch != 'CSE'  or branch != 'IT' or branch != 'EEE' or branch != 'DS'; 
select avg(fee) from student 
where college = 'ACET' and branch = 'CSE';
select gender , count(*)
from student 
where college = 'ACOE'
group by gender;
