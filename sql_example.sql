...
---1
Select
  id,name,date_of_joining from employee ;
  ---2
...
---3
 ...
 ---5
 Select  name, salary, department from employee  where gender = 'Male' and department in('SW','Testing') and salary > '50000';
 ---6
 ...
 ---9
  Select id, name, gender, department, salary, date_of_joining from employee where gender = 'Male' and department='Operations' and salary <=40000 and date_of_joining > TO_DATE('15-07-2021','DD-MM-YYYY');
---10
